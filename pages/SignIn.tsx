  ...
  return (
    <div className="h-screen bg-[#F8F4EF] flex flex-col p-8 pt-20 animate-fade-up overflow-y-auto no-scrollbar">
      <div className={`${lang === 'ar' ? 'text-right' : 'text-left'} space-y-4 mb-12`}>
        <h2 className="text-4xl font-black text-[#2C1810]">{t.welcomeBack}</h2>
        <p className="text-[#8B4513] font-bold">{t.signInDesc}</p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className={`text-center`}>
          <Link to="/signup" className="text-[#8B4513] font-bold text-sm hover:underline">{t.dontHaveAccount}</Link>
        </div>
